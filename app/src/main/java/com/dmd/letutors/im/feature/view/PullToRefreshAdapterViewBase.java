...
//			removeIndicatorViews();
	...
	protected void handleStyledAttributes(TypedArray a) {
		...
		mShowIndicator = a.getBoolean(ResourceLoader.getIdByName(getContext(), "styleable", "aliwx_PullToRefresh_ptrShowIndicator"), DEFAULT_SHOW_INDICATOR);
	}
	...
	protected void onPullToRefresh() {
		...
		WxLog.d("setting", "onPullToRefresh");
...
//			}
	...
	protected void onReleaseToRefresh() {
		...
		WxLog.d("setting", "onReleaseToRefresh");
